...
public class DataModeler {
     ...
     * @return Date
     */
    public Date epochToDateTime_x1000(String epoch) {
    ...
    public DefaultCategoryDataset createRandomCategoryDataset(){
    ...
    public double avgValue(double highValue, double lowValue) {
