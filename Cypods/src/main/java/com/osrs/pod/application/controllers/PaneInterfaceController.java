...
import com.osrs.pod.application.models.GeSearchArea;
import com.osrs.pod.application.models.ItemInfoArea;
...
public class PaneInterfaceController extends DisplayController implements Runnable {
...
//	HashMap<String, GeSearchResultLabel> geSearchResultLabelMap = geSearchArea.getGeSearchResultLabelMap();
	...
	public PaneInterfaceController() {
	}

	public PaneInterfaceController(Boolean init) {
